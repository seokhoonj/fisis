"""Shared test fixtures for fisis."""

from __future__ import annotations

import pytest

from fisis import _config
...
def _reset_credbox_binding(monkeypatch):
    ...
    monkeypatch.delenv("FISIS_STORE_APP", raising=False)
    monkeypatch.delenv("FISIS_NAMESPACE", raising=False)
